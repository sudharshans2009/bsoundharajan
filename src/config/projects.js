...
export const projects = [
  ...
  {
    title: <>Reservoir storage capacity estimation and geological evaluation of sediment resources</>,
    funding: <>KEMDEL</>,
    completed: true
  },
  {
    title: <>Mitigation of climate change impacts on Indian Agriculture through improved irrigation water management</>,
    funding: <>Natural Environment Research Council, UK</>,
    completed: true
  },
  {
    title: <>Local response to extreme events due to climate change – Asian trans-boundary river basin: a case study</>,
    funding: <>Brown University, USA</>,
    completed: true
  },
  {
    title: <>Mitigation of Green House Gas (GHG) emission from rice fields – through water management</>,
    funding: <>Climate Food and Farming Research Network (CLIFF)</>,
    completed: true
  }
];