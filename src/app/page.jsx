    ...
    <>
      <div className="mt-20 w-full max-w-5xl mx-auto p-5 flex gap-10 lg:flex-row flex-col-reverse">
        <div className="flex-1">
          ...
          <p className="mt-1 border-b border-maincolor hover:border-white transition-all w-max border-dashed"><Link href="mailto:b_soundharajan@cb.maincolor.edu"><AtSign width={20} height={20} className="inline-flex" /> b_soundharajan@cb.amrita.edu</Link></p>
