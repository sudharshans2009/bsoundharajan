  ...
  return (
    <>
      <div className="mt-20 w-full max-w-5xl mx-auto p-5">
        <h1 className="font-semibold text-[20px] text-amrita mb-5">Ongoing Funded Research Projects</h1>
      ...
      <div className="mt-20 w-full max-w-5xl mx-auto p-5">
      <h1 className="font-semibold text-[20px] text-amrita mb-5">Completed Projects</h1>
        <Table className="border">
          <TableHeader>
            <TableRow className="w-full">
